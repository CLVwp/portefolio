...
import { DEFAULT_CHART_CONFIG } from "./chart-springs";
import {
...
// re-stroke. Spring tuning comes from `DEFAULT_CHART_CONFIG.highlightSpring`.
...
export function useHighlightSegment({
  ...
  const { highlightSpring } = DEFAULT_CHART_CONFIG;
